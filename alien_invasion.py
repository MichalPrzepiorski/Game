...
class AlienInvasion:
    ...
    def _update_bullets(self):
        """Uaktualnienie położenia pocisków i usunięciecie tych niewidocznych na ekranie."""
    ...
    def _create_fleet(self):
        ...
        #Ustalenie, ile rzędów obych zmieści się na ekranie.
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                #Tak samo jak w przypadku zderzenie statku z obcymi.
                self._ship_hit()
                break
