...
class Ship(Sprite):
    ...
    def __init__(self,ai_game):
        ...
        #Wczytanie obrazu statku kosmicznego i pobranie prostokąta
        ...
        #Położenie poziome statku jest przechowywawne w postaci liczby zmiennoprzecinkowej.
    ...
    def update(self):
        ...
        #Uaktualnienie wartiości współrzędnej X statku, a nie jego prostokąta.
